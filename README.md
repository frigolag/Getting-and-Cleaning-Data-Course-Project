...
- `run_analysis.R` contains the R script that performs the analysis on the raw data.
- `tidy_dataset.txt` is the end result from running the code on `run_analysis.R`. 
